...
from micclip.dataset import make_data_loader
from micclip.solver import make_lr_scheduler, make_optimizer
from micclip.engine.inference import inference
from micclip.engine.trainer import do_train
from micclip.modeling.detector import build_detection_model
from micclip.utils.checkpoint import ActionCheckpointer
from micclip.utils.comm import synchronize, get_rank
from micclip.utils.logger import setup_logger, setup_tblogger
from micclip.utils.random_seed import set_seed
from micclip.utils.IA_helper import has_memory
from micclip.structures.memory_pool import MemoryPool
# pytorch issuse #973
import resource
...
def main():
    ...
    parser.add_argument(
        "--config-file",
        default="config_files/mic_clip.yaml",
        metavar="FILE",
