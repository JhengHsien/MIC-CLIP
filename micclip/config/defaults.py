...
_C.MODEL.ROI_ACTION_HEAD.NUM_PERSON_MOVEMENT_CLASSES = 16 # zero shot: 15
...
# sin motion loss
_C.MODEL.ROI_ACTION_HEAD.MOTION_LOSS_WEIGHT = 2.0
...
_C.MODEL.HIT_STRUCTURE.STRUCTURE = "serial"
_C.MODEL.HIT_STRUCTURE.MAX_PER_SEC = 5
_C.MODEL.HIT_STRUCTURE.MAX_PERSON = 25
_C.MODEL.HIT_STRUCTURE.MAX_KEYPOINTS = 25
...
_C.MODEL.HIT_STRUCTURE.LENGTH = (4,4)
...
_C.MODEL.HIT_STRUCTURE.I_BLOCK_LIST = ['P', 'O', 'S', 'M', 'P', 'O', 'S', 'M']
...
_C.MODEL.HIT_STRUCTURE.VIDEOS_PER_BATCH = 8
...
# Pose
# ---------------------------------------------------------------------------- #
_C.MODEL.ROI_ACTION_HEAD.POSE_EXTRACTOR= 'Pose_extractor'
_C.MODEL.ROI_ACTION_HEAD.ADAPTER= 'Adapter'
_C.MODEL.ROI_ACTION_HEAD.MOTION = 'Motion'
_C.MODEL.ROI_ACTION_HEAD.LOCATION = 'Location'
