...
class CLIPencoder(nn.Module):
    ...
    def generate_person_feature(self,image_paths,proposals,write_txt = False):
        ...
        for i in range(len(image_paths)):
            ...
            for j in range(box_num):
                ...
                actor.append((x1,y1,x2,y2))
            person_bbox.append(actor)
        ...
        #f.close()
        return wanted_features, person_bbox
    ...
    def generate_prompt_iFeature(self,image_paths,proposals):
        ...
        # image_input = avg_pool(image_input)
        # image_input = F.interpolate(image_input, scale_factor=4, mode='nearest')
    ...
    def forward(self, image_paths, proposals, objects):
        ...
        #take person feature
        person_feature, person_bbox = self.generate_person_feature(image_paths,proposals)
        ...
        return tFeature, iFeature, person_feature, object_feature, prompt_iFeature, person_bbox
